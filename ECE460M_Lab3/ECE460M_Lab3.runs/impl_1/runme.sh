...
HD_PWD='C:/Users/angel/ECE460M_Lab3/ECE460M_Lab3.runs/impl_1'
cd "$HD_PWD"
...
EAStep vivado -log TopTest.vdi -applog -m64 -product Vivado -messageDb vivado.pb -mode batch -source TopTest.tcl -notrace
