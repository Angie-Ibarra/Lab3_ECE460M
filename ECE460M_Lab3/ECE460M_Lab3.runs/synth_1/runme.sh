...
HD_PWD='C:/Users/angel/ECE460M_Lab3/ECE460M_Lab3.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log TopTest.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source TopTest.tcl
